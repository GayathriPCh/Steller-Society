    ...
    return (
        <div style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', display: "flex", justifyContent: "center", alignItems: "center", height: "100vh" }}>
            <div style={{ backgroundColor: "#131324", padding: "2rem", borderRadius: "1rem", width: "500px", boxShadow: "0 8px 32px 0 rgba(31, 38, 135, 0.37)", display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <h2 style={{ color: "#ffffff", textAlign: "center", marginBottom: "1rem", textTransform: "uppercase" }}>Register</h2>
                <form onSubmit={handleSubmit} style={{ width: "100%" }}>
                    <div style={{ marginBottom: "1rem" }}>
                        <label htmlFor="name" style={{ color: "#ffffff", fontWeight: "bold", display: "block", marginBottom: "0.5rem" }}>
                            Name
                        </label>
                        <input
                            type="text"
                ...
                <p style={{ marginTop: "1rem", color: "#ffffff", textAlign: "center" }}>Already have an Account? <Link to="/login" style={{ textDecoration: "none", color: "#4e0eff", fontWeight: "bold" }}>Login</Link></p>
            </div>
        </div>
    );
}
